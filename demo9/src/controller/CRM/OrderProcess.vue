<template>
    ...
    <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="date" label="节点名称" width="120" />
        <el-table-column prop="name" label="节点值" width="120" />
        <el-table-column prop="name" label="权限分公司" width="120" />
        <el-table-column prop="name" label="权限部门" width="120" />
        <el-table-column prop="name" label="权限岗位" width="120" />
        <el-table-column prop="name" label="审核列表" width="120" />
        <el-table-column prop="name" label="行为节点" width="120" />
        <el-table-column prop="name" label="驳回节点" width="120" />
    ...
    <el-dialog v-model="dialogFormVisible" title="新增/修改行为节点" @close="addDialogClosed" :close-on-click-modal='false'
        draggable>
        <!-- <el-divider /> -->
        <el-form :model="addForm" :rules="addForm" ref="addFormRef">
            ...
            <el-form-item label="描述：" prop="payment" :label-width="formLabelWidth">
                <el-input  type="textarea" v-model="addForm.payment" placeholder="请输入联系人" class="textarea" />
