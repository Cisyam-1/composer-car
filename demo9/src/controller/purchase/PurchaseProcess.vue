<template>
    ...
    <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="date" label="节点名称" width="150" />
        <el-table-column prop="name" label="节点值" width="150" />
        <el-table-column prop="name" label="权限分公司" width="150" />
        <el-table-column prop="name" label="权限部门" width="150" />
        <el-table-column prop="name" label="权限岗位" width="150" />
        <el-table-column prop="name" label="审核列表" width="150" />
        <el-table-column prop="name" label="行为节点" width="150" />
        <el-table-column prop="name" label="驳回节点" width="150" />
        <el-table-column prop="name" label="字段控制" width="150" />
    ...
    <el-dialog v-model="dialogFormVisible" title="新增/修改订单流程" @close="addDialogClosed" :close-on-click-modal='false'
        draggable class="purchaseprocess_dialog">
        <!-- <el-divider /> -->
