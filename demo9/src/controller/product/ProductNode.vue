<template>
    ...
    <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="有效" width="150" />
    ...
    <el-dialog v-model="dialogFormVisible" title="新增/修改生产BOM" @close="addDialogClosed" :close-on-click-modal='false'
        ...
        <el-form :model="addForm" :rules="addForm" ref="addFormRef">
            <el-form-item label="节点名称：" prop="payment" :label-width="formLabelWidth">
                <el-input placeholder="请输入节点名称" :style="style1" />
                <div class="tip">节点名称</div>
            </el-form-item>
            <el-form-item label="描述：" prop="payment" :label-width="formLabelWidth">
                <el-input v-model="addForm.payment" placeholder="请输入描述"  type="textarea" class="textarea"/>
