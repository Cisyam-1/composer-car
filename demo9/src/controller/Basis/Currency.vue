<template>
  ...
  <el-dialog v-model="dialogFormVisible" title="新增/修改币种管理" @close="addDialogClosed" :close-on-click-modal='false'>
    <!-- <el-divider /> -->
    <el-form :model="addForm" :rules="addForm" ref="addFormRef">
      <el-form-item label="币种名称：" prop="payment" :label-width="formLabelWidth">
        <el-input v-model="addForm.payment" style="width: 300px"/>
        <div class="tip">币种名称</div>
      </el-form-item>
...
export default{
  data(){
    ...
    headArr:[
      {prop:"name", label:"币种名称" },
      {prop:"address", label:"标识"},
      {prop:"address", label:"默认"},  
    ]
