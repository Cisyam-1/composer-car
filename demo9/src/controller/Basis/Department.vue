    ...
    <div class="top">
          ...
          <div class="table">
            <el-table :data="tableData" border style="width: 100%">
              ...
              <el-table-column  label="修改"><el-icon @click="dialogFormVisible = true"><EditPen /></el-icon></el-table-column>
              <el-table-column  label="删除"><el-icon><Delete /></el-icon></el-table-column>
            </el-table>
            <FunctionKey/>
          </div>
          <el-dialog v-model="dialogFormVisible" title="新增/修改部门名称" @close="addDialogClosed" :close-on-click-modal='false'>
    <!-- <el-divider /> -->
    <el-form :model="addForm" :rules="addForm" ref="addFormRef">
      <el-form-item label="部门名称：" prop="payment" :label-width="formLabelWidth">
        <el-input v-model="addForm.payment" style="width: 300px;"/>
        <div class="tip">部门名称</div>
      </el-form-item>     
    </el-form>
    <template #footer>
