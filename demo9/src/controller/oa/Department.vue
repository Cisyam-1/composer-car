<template>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column label="删除"><el-icon><Delete /></el-icon>       
      </el-table-column>
    </el-table>
    <FunctionKey/>
    <el-dialog v-model="dialogFormVisible" title="新增/修改部门" @close="addDialogClosed" :close-on-click-modal='false'>
    <!-- <el-divider /> -->
    <el-form :model="addForm" :rules="addForm" ref="addFormRef">
      <el-form-item label="部门名称：" prop="payment" :label-width="formLabelWidth" placeholder="请输入部门名称">
  ...
  data() {
    return {
      ...
      headArr:[
        ...
        {prop:"address", label:"子数目"},
        {prop:"address", label:"排序"}
      ]
